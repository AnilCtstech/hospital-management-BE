...
public class EditAppointment {
	...
	private String prevApointmentDetail;
	...
	public String getPrevApointmentDetail() {
		return prevApointmentDetail;
	}

	public void setPrevApointmentDetail(String prevApointmentDetail) {
		this.prevApointmentDetail = prevApointmentDetail;
	}
